...
class CategoryNotFoundException(CustomBaseException):
    pass


class CategoryValidationException(CustomBaseException):
    pass


class CategoryDatabaseException(CustomBaseException):
    pass


class CategoryCreationException(CustomBaseException):
    pass


class CategoryUpdateException(CustomBaseException):
    pass


class CategoryDeletionException(CustomBaseException):
    pass