...
from src.dto.base import BaseDTO, IdDTOMixin, TimestampDTOMixin
from src.dto.category import CategoryResponseDTO
...
class PollResponseDTO(BaseDTO, IdDTOMixin, TimestampDTOMixin):
    ...
    is_active: bool
    is_anonymous: bool
    options: list[PollOptionResponseDTO] = Field(default_factory=list)
